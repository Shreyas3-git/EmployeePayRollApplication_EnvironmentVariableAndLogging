...
public class EmployeeController 
{
	...
	public ResponseEntity<ResponseDTO> getEmployeePayRollData()
	{
		try 
		{
			log.info("All will be data rertrive:");
	...
	public ResponseEntity<ResponseDTO> addEmployeePayRollData(@Valid @RequestBody EmployeeDTO employeeDTO)
	{
		try 
		{
			log.info("Inserting Employee into database table:"+employeeDTO);
		...
		{
			ResponseDTO dto = new ResponseDTO("Error while processing the request:",null);
			return new ResponseEntity(dto,HttpStatus.BAD_REQUEST);
		}
	...
	public ResponseEntity<ResponseDTO> updateEmployeePayRollData( @RequestBody EmployeeDTO employeeDTO,@PathVariable int id)
	{
		try
		{
